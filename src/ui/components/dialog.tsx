        ...
        >
          ...
          >
            {!persistent && (
              <button
                onClick={onClose}
                className="absolute top-2.5 right-2.5 p-3 rounded-full text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-200 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors cursor-pointer"
